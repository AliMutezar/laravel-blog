      ...
      <main class="form-registration w-100 m-auto">
          <form action="/register" method="POST">
            ...
            <div class="form-floating">
              <input type="text" name="name" class="form-control rounded-top @error('name') is-invalid @enderror" id="name" placeholder="Your fullname" value="{{ old('name') }}" required>
            ...
            <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">Register Account</button>
            <small class="d-block text-center mt-3">Already registed ?!
