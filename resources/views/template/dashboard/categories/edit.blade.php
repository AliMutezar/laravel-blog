            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/dashboard/categories/{{ $category->slug }}" class="forms-sample" method="POST">
                            @method('put')
                            @csrf
                            
                            <div class="form-group">
                                <label for="name">Category Name</label>
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="title" placeholder="Category Name" value="{{ old('title', $category->name) }}">
                            ...
                            <div class="d-flex">
                                <button type="submit" class="btn btn-primary me-2 d-flex align-item-center">
                                    ...
                                    <span class="ms-2"></span> Update Category
                                </button>
